...
reported privately to the maintainer through the contact options on the
`@lorytek` GitHub profile.
...
clarity around the nature of the violation and why the behavior was
...
the Code of Conduct, for a specified period of time.
...
including sustained inappropriate behavior, harassment, or aggression toward or
