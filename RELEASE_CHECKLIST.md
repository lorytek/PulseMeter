...
- [ ] Run `powershell -ExecutionPolicy Bypass -File .\scripts\package-release.ps1 -Version 0.6.0`.
...
- [ ] Attach `PulseMeter-0.6.0-win-x64-portable.zip` and its `.sha256` checksum file to the GitHub release.
