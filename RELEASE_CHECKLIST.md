...
- [ ] Run `powershell -ExecutionPolicy Bypass -File .\scripts\package-release.ps1 -Version 0.2.1`.
...
- [ ] Attach `PulseMeter-0.2.1-win-x64-portable.zip` to the GitHub release.
